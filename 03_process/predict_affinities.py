...
def predict_affinities(setup, iteration, sample):
    ...
    print("Predicting affinities of setup %s, iteration %s, in sample%s"%(setup, iteration, sample))
    ...
    with build(pipeline):
        ...
        # predict affs only in origingal raw ROI
